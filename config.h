...
static const int user_bh            = 0;        /* 0 means dwm will calculate bar height, > = 1 means dwm will user_bh as bar height */
static const char *fonts[]          = { "JetBrains Mono:size=15", "JoyPixels:pixelsize=11:antialias=true:autohint=true"};
